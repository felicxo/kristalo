...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Kristalo web application."
  #
  #
  ...
  #
  # settings.secret_key_base= t2TyfNYBX_R_gDirtbyx4vSRVEwZ_ZDmHBArSMINxrM
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("kristalo.log", "w"))
  #
  #
end
